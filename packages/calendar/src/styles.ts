...
export const calendar = tv({
  slots: {
    ...
    datePickerControl:
      'focus-visible:ring-primary flex h-[var(--size)] w-[calc((var(--size)*7)/3+1rem)] cursor-pointer appearance-none items-center justify-center rounded-md border-0 bg-transparent p-0 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-white data-[disabled=true]:cursor-not-allowed dark:hover:bg-white/10 focus-visible:dark:ring-offset-gray-900',
  },
