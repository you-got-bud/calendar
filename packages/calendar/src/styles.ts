...
export const calendar = tv({
  slots: {
    ...
    day: 'focus-visible:ring-primary data-[first-in-range]:text-primary-foreground data-[static]:user-select-auto data-[outside]:text-muted-foreground data-[selected]:bg-primary text-primary-contrast data-[in-range]:bg-primary/10 data-[first-in-range]:bg-primary data-[in-range]:dark:bg-primary/10 data-[in-range]:bg-primary/10 dark:data-[in-range]:bg-primary/10 dark:data-[in-range]:dark:bg-primary/10 dark:data-[in-range]:dark:bg-primary/10 data-[in-range]:bg-primary/10 data-[in-range]:data-[selected]:bg-primary data-[selected]:text-primary-foreground data-[in-range]:data-[selected]:hover:bg-primary data-[in-range]:data-[selected]:text-primary-foreground inline-flex h-[var(--size)] w-[var(--size)] cursor-pointer items-center justify-center justify-center rounded-md bg-transparent p-0 text-[calc(var(--size)/2.8)] focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-white data-[disabled]:cursor-not-allowed data-[static]:cursor-default data-[first-in-range]:data-[last-in-range]:rounded-md data-[in-range]:rounded-none data-[first-in-range]:rounded-l-md data-[last-in-range]:rounded-r-md data-[weekend]:text-red-500 focus-visible:dark:ring-offset-gray-900 hover:[&:where(:not([data-static],[data-disabled],[data-selected],[data-in-range]))]:bg-gray-100 dark:hover:[&:where(:not([data-static],[data-disabled],[data-selected],[data-in-range]))]:bg-gray-800',
    calendarHeaderControl:
      'flex h-[var(--size)] w-[var(--size)] cursor-pointer items-center justify-center rounded-md bg-transparent p-0 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-white data-[disabled=true]:cursor-not-allowed dark:hover:bg-gray-800 focus-visible:dark:ring-offset-gray-900',
    calendarHeaderLevel:
    ...
    monthListControl:
      'text-foreground h-[var(--size)] w-[calc((var(--size)*7/3)+.09375rem)] rounded-md hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-white data-[disabled=true]:cursor-not-allowed dark:hover:bg-gray-800 focus-visible:dark:ring-offset-gray-900',
    inputGroup:
