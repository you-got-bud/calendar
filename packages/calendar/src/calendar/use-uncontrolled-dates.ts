      ...
      switch (type) {
        case 'default':
          if (value !== null && typeof value !== 'string') {
            ...
            console.error(
              '[use-uncontrolled-dates] Value must be type of `null` or `string`'
            )
          }
          break
        case 'multiple':
          if (!(value instanceof Array)) {
            // eslint-disable-next-line no-console
            console.error(
              '[use-uncontrolled-dates] Value must be type of `string[]`'
            )
          }
          break
        case 'range':
          if (!(value instanceof Array) || value.length !== 2) {
            // eslint-disable-next-line no-console
            console.error(
              '[use-uncontrolled-dates] Value must be type of `[string, string]`'
            )
          }
          break
      }
